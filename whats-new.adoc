...
[role="lead"]
Conozca los cambios más recientes en los servicios cloud que forman parte de la plataforma BlueXP (anteriormente Cloud Manager). Si quiere más información, consulte link:release-notes-index.html["conjunto completo de notas de la versión"] por cada servicio individual.
